        ...
        table.setModel(new DefaultTableModel(
            new Object[][] {
                {"Juan Martinez", new ImageIcon[] {
                    new ImageIcon(ClassPanel.class.getResource("/ImagenesGym/boton-editar.png")),
                    new ImageIcon(ClassPanel.class.getResource("/ImagenesGym/quitar-usuario.png")),
                    new ImageIcon(ClassPanel.class.getResource("/ImagenesGym/ver-detalles.png"))
                }},
